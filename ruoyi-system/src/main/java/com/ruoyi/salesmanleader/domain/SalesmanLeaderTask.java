 ...
 * @date 2020-08-27
 */
public class SalesmanLeaderTask
{
    ...
    /** 商业任务信息明细信息 */
    private List<SalesmanLeaderTaskDetail> dtBusinessTaskDetailList;
    ...
    public List<SalesmanLeaderTaskDetail> getDtBusinessTaskDetailList()
    {
        return dtBusinessTaskDetailList;
    }

    public void setDtBusinessTaskDetailList(List<SalesmanLeaderTaskDetail> dtBusinessTaskDetailList)
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("dtBusinessTaskDetailList", getDtBusinessTaskDetailList())
            .toString();
    }
}
