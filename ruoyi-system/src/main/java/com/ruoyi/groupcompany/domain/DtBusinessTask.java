...
public class DtBusinessTask
{
    ...
    public List<DtBusinessTaskDetail> getDtBusinessTaskDetailList()
    {
        return dtBusinessTaskDetailList;
    }

    public void setDtBusinessTaskDetailList(List<DtBusinessTaskDetail> dtBusinessTaskDetailList)
    {
